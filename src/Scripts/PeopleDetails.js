...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function fetchPeoples() {
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/User/TopUsers', {
            method: 'POST',
            headers: {
    ...
    async function fetchUserSideBarInfo() {
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/User/UserSideBarInfo', {
            method: 'POST',
            headers: {
                'Authorization': 'Bearer '+localStorage.getItem('token'),
                'Content-Type': 'application/json',
...
async function AddFollowRequest(followerid) {
    ...
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/User/AddFollow', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer '+localStorage.getItem('token'),
            'Content-Type': 'application/json',
...
async function RemoveFollowRequest(followerid) {
    ...
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/User/RemoveFollow', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer '+localStorage.getItem('token'),
            'Content-Type': 'application/json',
...
async function NotificationInfo() {
    var flag=0;
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/User/UserNotifications', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer '+localStorage.getItem('token'),
            'Content-Type': 'application/json',
