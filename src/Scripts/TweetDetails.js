...
document.addEventListener('DOMContentLoaded',async function () {
  ...
  document.querySelector('.modal-header button').addEventListener('click', function () {
    ...
    async function addTweetComment(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/AddTweetComment', {
            method: 'POST',
            headers: {
    ...
    async function addReplyReply(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/AddReplytoReply', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
    ...
    async function addCommentReply(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/AddCommentReply', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
    ...
    async function EditTweetContent(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/UpdateTweetsCommentContent', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
    ...
    async function EditRetweetContent(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/UpdateReweetsCommentContent', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
    ...
    async function addRetweetComment(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/AddRetweetComment', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
    ...
    async function addRetweetCommentReply(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/AddRetweetCommentReply', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
    ...
    async function RetweetaddReplyReply(){
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/AddRetweetCommentReplytoReply', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
             },
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function fetchTweets() {
      ...
      await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/TweetDetails', {
          method: 'POST',
          headers: {
    ...
    async function fetchComments(tweet) {
        // console.log('ghj')
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/CommentDetails', {
            method: 'POST',
            headers: {
                'Authorization': 'Bearer '+localStorage.getItem('token'),
                'Content-Type': 'application/json',
    ...
    async function fetchRetweets() {
        ...
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/RetweetDetails', {
            method: 'POST',
            headers: {
                'Authorization': 'Bearer '+localStorage.getItem('token'),
                'Content-Type': 'application/json',
    ...
    async function fetchRetweetComments(tweet) {
        await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Comments/RetweetCommentDetails', {
            method: 'POST',
            headers: {
                'Authorization': 'Bearer '+localStorage.getItem('token'),
                'Content-Type': 'application/json',
...
function renderRetweet(tweet,comments) {
    ...
    // retweets.forEach(tweet => {
        ...
        if(tweet.retweetOwnerId==localStorage.getItem('userid')){
            userHandleSpan.appendChild(span)
            userHandleSpan.style.fontSize = '12px'
...
async function updateLikeStatus(tweetId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
...
async function updateTweetDisLikeStatus(tweetId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetDisLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateRetweetLikeStatus(tweetId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddReTweetLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateRetweetDisLikeStatus(tweetId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddReTweetDisLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
...
async function updateTweetCommentLikeStatus(commentId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetCommentLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateTweetCommentDisLikeStatus(commentId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetCommentDislike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateTweetCommentReplyLikeStatus(replyid) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetCommentReplyLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
   ...
   async function updateTweetCommentReplyDisLikeStatus(replyid) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetCommentReplyDislike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateRetweetCommentLikeStatus(commentId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddRetweetCommentLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateRetweetCommentDislikeLikeStatus(commentId) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddRetweetCommentDislike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateRetweetCommentReplyLikeStatus(replyid) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddRetweetCommentReplyLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
  ...
  async function updateRetweetCommentReplyDisLikeStatus(replyid) {
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddRetweetCommentReplyDisLike', {
        method: 'POST',
        headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('token'),
            'Content-Type': 'application/json',
