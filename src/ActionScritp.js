...
document.querySelector('.modal-header button').addEventListener('click', function () {
    ...
    async function addFeedContent(){
      ...
      await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetContent', {
          method: 'POST',
          headers: {
  ...
  async function addRetweetContent(actualtweetid){
    ...
    await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddRetweetContent', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
         },
  ...
  async function addFeedImages(){
        fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/AddTweetImage', {
            method: 'POST',
            body: formData
        })
        .then(data => {
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function fetchTweets() {
      ...
      await fetch('https://bloggingapppresidioshare.azurewebsites.net/api/Tweet/Feeds', {
          method: 'POST',
          headers: {
              'Authorization': 'Bearer '+localStorage.getItem('token'),
              'Content-Type': 'application/json',
